...
// 初始化
void init_json(){
	lpt[0] = {0,0,1,"运行",1000,1,C,1};
	lpt[1] = {0,0,1,"运行",1000,1,C,1};
	...
	sm[0] = {0,0,"3号堆垛机","运行",0,0,0,0,10000,10000,37.49,0,0,0,0,0,0,10000,10000,37.49,0,0,0,0,0,0,10000,10000,37.49,0,0,0,0,10000,10000,37.49,0,0,0,'0'};
	sm[1] = {0,0,"4号堆垛机","运行",0,0,0,0,10000,10000,41.27,0,0,0,0,0,0,10000,10000,41.27,0,0,0,0,0,0,10000,10000,41.27,0,0,0,0,10000,10000,41.27,0,0,0,'0'};
	sm[2] = {0,0,"5号堆垛机","运行",0,0,0,0,10000,10000,44.04,0,0,0,0,0,0,10000,10000,44.04,0,0,0,0,0,0,10000,10000,44.04,0,0,0,0,10000,10000,44.04,0,0,0,'0'};
	sm[3] = {0,0,"6号堆垛机","运行",0,0,0,0,10000,10000,46.74,0,0,0,0,0,0,10000,10000,46.74,0,0,0,0,0,0,10000,10000,46.74,0,0,0,0,10000,10000,46.74,0,0,0,'0'};
	sm[4] = {0,0,"7号堆垛机","运行",0,0,0,0,10000,10000,49.48,0,0,0,0,0,0,10000,10000,49.48,0,0,0,0,0,0,10000,10000,49.48,0,0,0,0,10000,10000,49.48,0,0,0,'0'};
	sm[5] = {0,0,"8号堆垛机","运行",0,0,0,0,10000,10000,52.38,0,0,0,0,0,0,10000,10000,52.38,0,0,0,0,0,0,10000,10000,52.38,0,0,0,0,10000,10000,52.38,0,0,0,'0'};
}
